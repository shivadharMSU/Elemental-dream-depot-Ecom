...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="adminHome.php"><img src="images/logo.jpeg" alt="Logo"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="manage_ite.php">Manage Items</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="left-section">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="manage_item.php" class="card-link btn btn-primary">Go to Manage</a>
                </div>
            </div>
        </div>
