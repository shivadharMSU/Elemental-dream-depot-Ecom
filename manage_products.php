...
if(isset($_POST['delete_id'])) {
    ...
    // Redirect to same page to refresh product list
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button type="button" class="btn btn-primary mt-2" data-bs-toggle="modal" data-bs-target="#editModal<?php echo $product['product_id']; ?>">Edit</button>
                    </div>
                </div>
            </div>
            <!-- Edit Modal -->
